  ...
  private void UpdateHead() {
    ...
    if (trackRotation) {
      ...
      if (target == null) {
		...
		//Camera.main.transform.rotation = target.rotation; // rotates forever. maybe a good idea to change the rotation of the 
      }
    }
    ...
    if (trackPosition) {
      ...
      if (target == null) {
		...
		//Camera.main.transform.position = transform.position; // to change the position of the camera! 
